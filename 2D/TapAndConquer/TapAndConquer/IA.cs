...
namespace TapAndConquer
{
    public class IA
    {
        ...
        private bool useBeginningStrategy(float deltaT)
        {
            ...
            {
                if (neutralFactories[i].getType() != 0)
        ...
        private bool useStandardStrategy()
        {
            ...
            if (weakest != null)
            {
                 ...
                 */
                if (nearest.getTroops() > weakest.getTroops() * 1.2f)
                {
                ...
                else
                {
                    ...
                    if (myFactories.Count > 1)
                    {
                        ...
                        for (int i = 0; i < myFactories.Count && !found; i++)
                        {
                            ...
                            if (helping.getTroops() + nearest.getTroops() > weakest.getTroops())
                            {
                                found = true;
                            }
                            else
