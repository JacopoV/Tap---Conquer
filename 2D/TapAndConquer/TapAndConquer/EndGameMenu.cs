...
namespace TapAndConquer
{
    class EndGameMenu : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        private void loadContent()
        {
            ...
            menuButtonImage = Game.Content.Load<Texture2D>("main_menu");
            restartButtonImage = Game.Content.Load<Texture2D>("restart");
            winImage = Game.Content.Load<Texture2D>("win");
            looseImage = Game.Content.Load<Texture2D>("lose");
        }
        ...
        public override void Draw(GameTime gametime)
        {
            ...
            if(resultGame)
                spriteBatch.Draw(winImage, new Vector2(20, Game.GraphicsDevice.Viewport.Height - 200), Color.White);
            else
                spriteBatch.Draw(looseImage, new Vector2(20, Game.GraphicsDevice.Viewport.Height - 200), Color.White);
